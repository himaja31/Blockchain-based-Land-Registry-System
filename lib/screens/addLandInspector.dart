...
class _AddLandInspectorState extends State<AddLandInspector> {
  ...
  List<Menu> menuItems = [
    Menu(title: 'Add Official', icon: Icons.person_add),
    Menu(title: 'All Officials', icon: Icons.group),
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    labelText: 'New Owners\'s Address',
                    hintText: 'Enter new Application Owner Address',
                  ),
                ),
              ),
              CustomButton(
